        ...
        <nav className="bg-blue-600 p-4 shadow-lg">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <motion.div
                    ...
                    className={`absolute top-16 right-0 bg-blue-700 text-white lg:relative lg:flex lg:space-x-4 lg:top-auto lg:right-auto lg:bg-transparent lg:text-white items-center lg:shadow-none lg:p-0 ${isOpen ? 'block z-50 w-full' : 'hidden'} lg:block`}
                >
                    <Link to="/about" className="block px-4 py-2 hover:bg-blue-800 lg:hover:bg-transparent">
                        About Us
                    </Link>
                    <Link to="/contact" className="block px-4 py-2 hover:bg-blue-800 lg:hover:bg-transparent">
                        Contact Us
                    </Link>
                    ...
                    {user ? (
                        <>
                            {userRole === "principal" && (
                                <Link to="/dashboard" className="block px-4 py-2 hover:bg-blue-800 lg:hover:bg-transparent">
                                    Principal Dashboard
                                </Link>
                            )}
                            {userRole === "teacher" && (
                            ...
                            {userRole === "admin" && (
                                <Link to="/admin-dashboard" className="block px-4 py-2 hover:bg-blue-800 lg:hover:bg-transparent">
                                    Admin Dashboard
                                </Link>
                            )}
                            <button
                                onClick={logOut}
                                className="block px-4 py-2 hover:bg-blue-800 lg:hover:bg-transparent"
                            >
                                Logout
                            </button>
